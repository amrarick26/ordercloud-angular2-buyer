...
import { OcAuthResponse, OcMeGetResponse, OcMeCategoryList, OcMeProduct, OcMeProductList, OcMeAddressList } from './ordercloud-sdk.model';
...
export class OrderCloudSDK {
  ...
  Me = {
    ...
    ListAddresses: (options?: object): Observable<OcMeAddressList> => {
      return this.callApi('get', '/me/addresses', options)
    }
